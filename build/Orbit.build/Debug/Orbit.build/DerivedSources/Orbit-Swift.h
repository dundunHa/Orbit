...
#ifndef ORBIT_SWIFT_H
#define ORBIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Orbit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Orbit11AppDelegate")
...
@class NSScreen;
@class NSEvent;
SWIFT_CLASS("_TtC5Orbit13FloatingPanel")
...
SWIFT_CLASS("_TtC5Orbit13ScreenMonitor")
